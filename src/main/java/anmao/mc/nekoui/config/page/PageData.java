...
public class PageData {
    ...
    public static class ProjectData {
        ...
        public int getTextNormalColor() {
            return ColorHelper.HexToColor(textNormalColor);
        }
        public int getTextHighlightColor() {
            return ColorHelper.HexToColor(textHighlightColor);
        }
        public int getBackgroundNormalColor() {
            return ColorHelper.HexToColor(backgroundNormalColor);
        }
        public int getBackgroundHighlightColor() {
            return ColorHelper.HexToColor(backgroundHighlightColor);
        }
    }
}
