...
public class MobDirectionGui extends MobDirectionConfig{
    ...
    public MobDirectionGui(Minecraft minecraft){
        ...
        screenWidth = _Math.half(minecraft.getWindow().getScreenWidth());
        screenHeight = _Math.half(minecraft.getWindow().getScreenHeight());
    }
    ...
    private static void setRenderColor(Entity entity,GuiGraphics guiGraphics){
        int[] color = ColorHelper.extractRGBA(MobDirectionConfig.I.getEntityColor(entity)) ;
