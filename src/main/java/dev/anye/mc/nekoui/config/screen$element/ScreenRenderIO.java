...
public class ScreenRenderIO extends _JsonConfig<ScreenRender> {
	public ScreenRenderIO(String filePath, ScreenRender defaultData) {
		super(_File.getFilePath(Configs.CONFIG_DIR_SCREEN_ELEMENT, filePath), defaultData, new TypeToken<>() {}, false);
	}

	public ScreenRenderIO(String filePath) {
		this(filePath, ScreenRender.EMPTY);
	}
