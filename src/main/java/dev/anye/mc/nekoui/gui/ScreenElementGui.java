                ...
                screenRender.elements().forEach(element -> {
                    ...
                    if (!tmpS.isEmpty()) {
                        ...
                        if (color.equals("rainbow")) {
                            guiGraphics.text(Minecraft.getInstance().font, ComponentStyle.Flash(tmpS, rainbowType), dx, dy, 0);
                        } else {
                            guiGraphics.text(Minecraft.getInstance().font, tmpS, dx, dy, _ColorSupport.HexToColor(color));
                        }
                    }
